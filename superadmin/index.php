...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="Journal/Journal.php">Journal</a></li>
            <li><a href="GestionPersonnel/Personnel.php">Personnel</a></li>
            <li><a href="GestionUtilisateur/Utilisateur.php">Utilisateur</a></li>
            <li><a href="GestionProduits/Produits.php">Produits</a></li>
            <li><a href="GestionAliments/Aliments.php">Aliments</a></li>
            <li><a href="GestionFinances/Finances.php">Finances</a></li>
            <li><a href="GestionLocaux/CRUDLocaux.php">Locaux</a></li>
        </ul>
        <div class="logout">
