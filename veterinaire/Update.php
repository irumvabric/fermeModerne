...
<?php
  ...
  <div class="wrapper">
    ...
    <div class="form">
        ...
        <?php
        $insertSalle = "SELECT * FROM journal WHERE id='$id'";
...
?>
        <table>
            <tr>
              <td> Personne </td>
              <td>
              <select name="personne" value="<?php echo $journal['idPersonne']; ?>">
            ...
            <tr>
              <td> IDAnimal </td>
              <td>
              <select name="id_Animal"  value="<?php echo $journal['idAnimal']; ?>">
